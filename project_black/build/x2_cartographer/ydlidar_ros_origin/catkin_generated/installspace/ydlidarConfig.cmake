...
if("FALSE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/jetbot/project_black/src/x2_cartographer/ydlidar_ros_origin)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetbot/project_black/install/${idir}'.  ${_report}")
    endif()
