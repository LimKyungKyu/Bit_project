...
(cl:defmethod cl:initialize-instance :after ((m <get_degree>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_degree)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_ros_cpp-msg:<get_degree> is deprecated: use project_ros_cpp-msg:get_degree instead.")))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:roll-val is deprecated.  Use project_ros_cpp-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:pitch-val is deprecated.  Use project_ros_cpp-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:yaw-val is deprecated.  Use project_ros_cpp-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'imu_time_stamp-val :lambda-list '(m))
(cl:defmethod imu_time_stamp-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:imu_time_stamp-val is deprecated.  Use project_ros_cpp-msg:imu_time_stamp instead.")
  (imu_time_stamp m))

(cl:ensure-generic-function 'acc_x-val :lambda-list '(m))
(cl:defmethod acc_x-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:acc_x-val is deprecated.  Use project_ros_cpp-msg:acc_x instead.")
  (acc_x m))

(cl:ensure-generic-function 'acc_y-val :lambda-list '(m))
(cl:defmethod acc_y-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:acc_y-val is deprecated.  Use project_ros_cpp-msg:acc_y instead.")
  (acc_y m))

(cl:ensure-generic-function 'acc_z-val :lambda-list '(m))
(cl:defmethod acc_z-val ((m <get_degree>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:acc_z-val is deprecated.  Use project_ros_cpp-msg:acc_z instead.")
  (acc_z m))
