...
(cl:defmethod cl:initialize-instance :after ((m <nano_control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'nano_control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_ros_cpp-msg:<nano_control> is deprecated: use project_ros_cpp-msg:nano_control instead.")))

(cl:ensure-generic-function 'move_message-val :lambda-list '(m))
(cl:defmethod move_message-val ((m <nano_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_ros_cpp-msg:move_message-val is deprecated.  Use project_ros_cpp-msg:move_message instead.")
  (move_message m))
